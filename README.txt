...
--------------------------------------------------------
Repo: https://github.com/doka/install-aegir-on-ubuntu/tree/maverick
Raw script: https://raw.github.com/doka/install-aegir-on-ubuntu/maverick/install-aegir-on-ubuntu.sh
